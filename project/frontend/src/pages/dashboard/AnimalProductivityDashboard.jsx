        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 mb-6 sm:mb-8">
          ...
          <div className="bg-white rounded-lg shadow-md p-4 sm:p-6">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-base sm:text-lg font-bold text-slate-800">Animal Revenue & Cost Analysis</h2>
              <ChartInfoTooltip
                title="Animal Revenue & Cost Analysis"
                description="Compares gross market value generated vs feed and healthcare costs per animal group."
                howToRead={[
                  "Green Bar (Revenue): Total income/value produced by the animal group.",
                  "Orange Bar (Costs): Operational costs (feed, healthcare, maintenance).",
                  "Height Gap: The gap between Green and Orange represents net profit."
                ]}
                actionTip="Focus breeding and feed allocation on animal categories with the widest green revenue bars."
              />
            </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-4 sm:p-6">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-base sm:text-lg font-bold text-slate-800">Production Type Distribution</h2>
              <ChartInfoTooltip
                title="Production Type Distribution"
                description="Displays the proportion of total farm output generated by production category."
                howToRead={[
                  "Pie Slices: Breakdown of Milk, Eggs, Meat, and Wool production volume.",
                  "Percentages: Relative contribution of each category to overall output."
                ]}
                actionTip="Diversify production types to balance seasonal price fluctuations."
              />
            </div>
